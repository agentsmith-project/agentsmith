...
export function PreviewSection({
  ...
  return (
    <div className="rounded-md bg-surface-high/16 p-3 space-y-3" data-testid="files__details-preview">
      ...
      {previewKind === 'none' ? (
        <div className="h-40 rounded-md bg-surface-high/28 flex flex-col items-center justify-center text-tertiary gap-2">
        ...
        <div className="h-40 rounded-md bg-surface-high/28 flex items-center justify-center text-tertiary text-sm">
          {t('file_manager.preview_loading')}
        </div>
      ) : previewError ? (
        <div className="h-40 rounded-md bg-surface-high/28 flex flex-col items-center justify-center text-tertiary text-sm gap-2">
        ...
        <iframe src={objectUrl} title={basename(meta.key)} className="h-[320px] w-full rounded-md bg-surface-high/28" />
      ) : previewKind === 'text' ? (
        <div className="rounded-md bg-surface-high/28 p-2 max-h-[320px] overflow-auto">
