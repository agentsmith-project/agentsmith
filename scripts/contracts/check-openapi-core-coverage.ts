...
const REQUIRED_OPERATIONS: Array<{ method: string; path: string }> = [
  ...
  { method: 'get', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/source-libraries' },
  { method: 'post', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/source-libraries' },
  { method: 'get', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/source-libraries/{libraryId}/objects' },
  { method: 'post', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/source-libraries/{libraryId}/objects/upload' },
