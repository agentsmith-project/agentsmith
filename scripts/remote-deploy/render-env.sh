...
for resolved_key in \
  ...
  RESOLVED_KIND_STORAGE_ENDPOINT \
...
INTERNAL_AGENT_JUICEFS_META_HOST_OVERRIDE=${RESOLVED_KIND_GATEWAY_HOST}
INTERNAL_AGENT_JUICEFS_STORAGE_ENDPOINT_OVERRIDE=${RESOLVED_KIND_STORAGE_ENDPOINT}
EOF
