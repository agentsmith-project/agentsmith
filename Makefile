...
help-extended:
	...
	@echo "  npm run gate:release:full  # run the terminal automated release-grade verdict gate"
	@echo ""
...
quick-help:
	...
	@echo "    Run the default engineering gate."
	@echo ""
	@echo "  npm run gate:release:full"
	@echo "    Run the terminal automated release-grade verdict gate."
	@echo ""
	@echo "  make lane-mock"
	@echo "    Run the mock verification channel."
	@echo ""
	@echo "  make lane-visual"
	@echo "    Run the visual verification channel."
	@echo ""
	@echo "  make lane-real-release"
	@echo "    Run the full real-backend verification channel."
	@echo ""
	@echo "  npm run lane:demo-rehearsal"
	@echo "    Run the demo deployment rehearsal verification channel."
	@echo ""
