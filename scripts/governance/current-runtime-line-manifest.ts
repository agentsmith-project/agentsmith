...
export const CURRENT_RUNTIME_LINE_MANIFEST: readonly CurrentRuntimeLineDefinition[] = [
  {
    ...
    surface: 'local-flow',
    primaryUse: 'Daily development, real-backend manual validation, and Agent task / Agent Runner checks.',
  ...
  },
  {
    ...
    externalPath: 'Always includes the managed agent-task runner path.',
  ...
  },
  {
    ...
    internalPath: 'Always includes the internal Kubernetes execution path.',
    substrate: 'Compose substrate on the target host.',
    note: 'Mode describes automation boundary, not runner capability differences.',
