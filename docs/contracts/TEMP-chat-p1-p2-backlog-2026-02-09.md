...
- Status: in progress (state/model/cache + data query + stream orchestration + chat mutations + variant + composer/view-model hooks extracted; final wiring cleanup pending)
- Extract concerns:
