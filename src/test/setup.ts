...
const TEST_TRANSLATIONS: Record<string, string> = {
  ...
  'notebook.conversation.trace_error_unavailable_title': 'Trace details unavailable',
  'notebook.conversation.trace_error_forbidden_title': 'Trace access denied',
  'notebook.conversation.trace_error_network_title': 'Trace retrieval failed',
  'notebook.conversation.trace_error_failed_title': 'Trace details could not be loaded',
  ...
  'notebook.artifacts.save_dialog.description': 'Save this artifact to your file library so it can be reused later.',
  ...
  'notebook.artifacts.save_dialog.note_body': 'Saved files become available in the selected file library after the save completes.',
