...
export const CURRENT_WORKFLOW_GLOSSARY: readonly CurrentWorkflowGlossaryTerm[] = [
  ...
  },
  {
    ...
    currentMeaning: 'lane 定义的是在哪条真相路径下验证，例如 mock、full visual、backend-real；unified deploy lanes 仅保留为 legacy/focused diagnostics。',
...
export const CURRENT_WORKFLOW_DIAGNOSTIC_COMMANDS: readonly CurrentWorkflowDiagnosticCommand[] = [
  ...
  },
  {
    ...
    ownerSurface: 'legacy unified deploy substrate diagnostic',
    npmScript: 'lane:unified-deploy:substrate',
    gateId: 'lane-unified-deploy-substrate',
    workflowRole: 'diagnostic_lane',
    whenToUse: '需要定位 legacy unified deploy substrate reset / readiness 诊断。',
  ...
  },
  {
    ...
    ownerSurface: 'legacy unified deploy local-kind image diagnostic',
    npmScript: 'lane:unified-deploy:local-kind:images',
    gateId: 'lane-unified-deploy-local-kind-images',
    workflowRole: 'diagnostic_lane',
    whenToUse: '需要定位 legacy local-kind image handoff 诊断。',
  ...
  },
  {
    ...
    ownerSurface: 'legacy unified deploy local-kind rollout diagnostic',
    npmScript: 'lane:unified-deploy:local-kind',
    gateId: 'lane-unified-deploy-local-kind',
    workflowRole: 'diagnostic_lane',
    whenToUse: '需要定位 legacy local-kind Kubernetes rollout / ingress smoke 诊断。',
  ...
  },
  {
    ...
    ownerSurface: 'legacy unified deploy focused product-flow diagnostic',
    npmScript: 'lane:unified-deploy:product-flows',
    gateId: 'lane-unified-deploy-product-flows',
    workflowRole: 'diagnostic_lane',
    whenToUse: '需要定位 legacy deployed project / files / managed runner product-flow 诊断。',
  ...
  },
  {
    ...
    commands: [
      ...
      },
      {
        ...
        description: 'run the legacy unified deploy focused diagnostic for substrate',
        canonical: 'npm',
        npmScript: 'lane:unified-deploy:substrate',
        gateId: 'lane-unified-deploy-substrate',
        workflowRole: 'diagnostic_lane',
      },
      {
        ...
        description: 'run the legacy unified deploy focused diagnostic for local-kind images',
        canonical: 'npm',
        npmScript: 'lane:unified-deploy:local-kind:images',
        gateId: 'lane-unified-deploy-local-kind-images',
        workflowRole: 'diagnostic_lane',
      },
      {
        ...
        description: 'run the legacy unified deploy focused diagnostic for local-kind rollout',
        canonical: 'npm',
        npmScript: 'lane:unified-deploy:local-kind',
        gateId: 'lane-unified-deploy-local-kind',
        workflowRole: 'diagnostic_lane',
      },
      {
        ...
        description: 'run the legacy unified deploy focused diagnostic for product-flow',
        canonical: 'npm',
        npmScript: 'lane:unified-deploy:product-flows',
        gateId: 'lane-unified-deploy-product-flows',
        workflowRole: 'diagnostic_lane',
