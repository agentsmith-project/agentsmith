...
AgentSmith runner and Codex do not use the same discovery path list.
...
### 5.2.2 Runner Path Layout (current contract)
...
Open browser:
- Login: `http://localhost:<PORT_WEB>/zh-CN/login` (default `3001`, coexistence example `3101`)
