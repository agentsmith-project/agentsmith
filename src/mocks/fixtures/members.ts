...
export const memberProjectMembershipFixtures: ProjectMembership[] = [
  ...
  },
  {
    ...
    user_id: 'user_002',
    role: 'admin',
    permissions: ['project:read', 'project:agent:manage', 'project:endpoint:manage'],
    status: 'active',
  ...
  },
  {
    ...
    user_id: 'user_003',
    role: 'developer',
    permissions: ['project:read', 'project:agent:use', 'project:chat:access', 'project:notebook:access'],
    status: 'active',
  ...
  },
  {
    ...
    user_id: 'user_004',
    role: 'user',
    permissions: ['project:read', 'project:chat:access', 'project:notebook:access'],
    status: 'active',
  ...
  },
  {
    ...
    user_id: 'user_003',
    role: 'admin',
    permissions: ['project:read', 'project:agent:manage'],
    status: 'active',
