...
1. AgentSmith product readiness 通过。
...
最小治理核心只包括：product readiness、release-kit final GA verdict、post-deploy product smoke、digest/provenance/freshness、airgap offline closure、权限/secret/redaction/contract/source-boundary 检查。Standalone diagnostics、surface report、adoption report、candidate intake、runbook acceptance 和历史 evidence 不得单独升级为 GA gate。
