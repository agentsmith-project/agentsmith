...
release_check_forbid_pattern "${RELEASE_ROOT}/env/api.env" '^EXTERNAL_AGENT_' 'rendered_env_unexpected:api.env:EXTERNAL_AGENT'
release_check_forbid_pattern "${RELEASE_ROOT}/env/api.env" '^DOCKER_MANUAL_AGENT_' 'rendered_env_unexpected:api.env:DOCKER_MANUAL_AGENT'
...
release_check_forbid_pattern "${RELEASE_ROOT}/env/api.env" '^EXTERNAL_AGENT_' 'rendered_env_unexpected:simple:api.env:EXTERNAL_AGENT'
release_check_forbid_pattern "${RELEASE_ROOT}/env/api.env" '^DOCKER_MANUAL_AGENT_' 'rendered_env_unexpected:simple:api.env:DOCKER_MANUAL_AGENT'
