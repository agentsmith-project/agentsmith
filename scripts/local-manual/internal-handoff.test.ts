...
describe('local-manual internal handoff', () => {
  ...
  it('starts AFSCP from the pinned image by default before the internal sandbox and AgentSmith API restart', () => {
    ...
    expect(common).toContain('AFSCP_LOCAL_RUNTIME_IMAGE="${AFSCP_LOCAL_RUNTIME_IMAGE:-${AFSCP_IMAGE:-ghcr.io/agentsmith-project/agentsmith-fs-control-plane:v1.0.22@sha256:702c76775d828b9805056e51d841c0560eaaecb63a7f79a7e42d3f52de8029ca}}"');
  ...
  it('exposes a focused smoke for the pinned AFSCP image embedded JVS binary', () => {
    ...
    expect(script).toContain('ghcr.io/agentsmith-project/agentsmith-fs-control-plane:v1.0.22@sha256:702c76775d828b9805056e51d841c0560eaaecb63a7f79a7e42d3f52de8029ca');
