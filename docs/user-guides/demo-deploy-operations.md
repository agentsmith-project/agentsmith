...
- you want to demonstrate sandbox-backed Agent task execution

Use `simple` when:

- you only need the managed Agent task runner mainline
...
- Managed agent-task runner execution:
...
- `bootstrap` updates the seeded managed agent-task runner record as needed
