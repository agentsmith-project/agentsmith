...
describe('local-manual internal handoff', () => {
  ...
  it('exposes a focused smoke for the pinned AFSCP image embedded JVS binary', () => {
    ...
    expect(script).toContain('ghcr.io/agentsmith-project/agentsmith-fs-control-plane:v1.0.11@sha256:6ccaabe69d8761d071a130a0c4793662371f74b4d4a56a7e975e28acc5c65709');
