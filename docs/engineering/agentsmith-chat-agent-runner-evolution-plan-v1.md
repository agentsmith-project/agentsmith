...
| Runner split | agent execution protocol contract package, task runner package, builtin skills, terminal/session/workspace/artifact modules | Contract package owns protocol types/tests; task runner package owns execution-facing interfaces. |
