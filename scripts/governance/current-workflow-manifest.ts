    ...
    jobs: [
      {
        ...
        scheduled: false,
        productReadinessBlocking: false,
        notes: 'Runs AgentSmith product readiness with a downloaded release contract and always uploads the campaign evidence directory plus test reports; the final GA handoff report remains a success-only file check, not a failed-run verdict.',
      },
    ],
  }),
  defineCurrentCIWorkflow({
