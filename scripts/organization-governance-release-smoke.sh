...
ORGANIZATION_GOVERNANCE_RELEASE_EVIDENCE_PATH="${ORGANIZATION_GOVERNANCE_RELEASE_EVIDENCE_PATH:-}"
...
if [[ -n "${ORGANIZATION_GOVERNANCE_RELEASE_EVIDENCE_PATH}" ]]; then
  info "writing organization governance evidence"
  node scripts/write-organization-governance-release-evidence.js "${ORGANIZATION_GOVERNANCE_RELEASE_EVIDENCE_PATH}"
fi

info "organization governance release smoke passed"
