/**
 * Epic D: Governance Engineering - Integration E2E Tests
 *
 * Tests the CLI-based governance verification tools:
 * - verify-governance-report.ts (Governance Report Automation)
...
describe('Epic D: Governance Engineering - Integration Tests', () => {
  ...
  describe('verify-governance-report.ts - CLI Execution', () => {
    it('should run with --help and show usage', () => {
      ...
      expect(output).toContain('verify-governance-report');
  ...
  describe('Report Structure Validation', () => {
    it('should generate valid GovernanceReport JSON structure', () => {
  ...
  describe('Markdown Report Generation', () => {
    it('should generate properly formatted Markdown', () => {
      ...
      expect(mdContent).toMatch(/^# Governance Verification Report/m);
  ...
  describe('Epic D2: Failure Classification - Direct Test', () => {
    ...
    it('should classify various error types correctly', () => {
      ...
      const testCode = `
import { classifyFailure } from '${join(process.cwd(), 'scripts/governance/failure-classifier.ts')}';
