...
help-extended:
	...
	@echo "  make local-real-up  # start the real local environment"
	@echo "  make local-real-status  # show the real local environment status"
	@echo "  make local-real-down  # stop the real local environment"
	@echo "  make local-real-reset  # reset the real local environment"
	@echo ""
	@echo "Tests:"
	@echo "  npm run verify  # write a dry-run story acceptance report and print the recommended verification plan"
	@echo ""
	@echo "Release:"
	@echo "  npm run product:ready  # run the human-friendly AgentSmith product readiness wrapper"
	@echo "  npm run product:status  # read the latest product readiness summary in read-only mode"
	@echo ""
	@echo "Maintainer diagnostics (internal adapter context):"
	@echo "  package.json keeps gate/lane/backend-real/release:campaign scripts for CI, product:ready, and evidence owners."
	@echo "  release:ready/status remain deprecated transition aliases, not deployment/package/operator verdicts."
...
quick-help:
	...
	@echo "    Start the real local environment."
	@echo ""
	@echo "  make local-real-status"
	@echo "    Show the real local environment status."
	@echo ""
	@echo "  make local-real-down"
	@echo "    Stop the real local environment."
	@echo ""
	@echo "  make local-real-reset"
	@echo "    Reset the real local environment."
	@echo ""
	@echo "  npm run verify"
	@echo "    Write a dry-run story acceptance report and print the recommended verification plan."
	@echo ""
	@echo "  npm run product:ready"
	@echo "    Run the human-friendly AgentSmith product readiness wrapper."
	@echo ""
	@echo "  npm run product:status"
	@echo "    Read the latest product readiness summary in read-only mode."
	@echo ""
	@echo "  release:ready/status"
	@echo "    Deprecated transition aliases; not deployment/package/operator verdicts."
	@echo ""
...
agent-task-runner:
	...
	MBOS_AGENT_BUILTIN_SKILLS="$${MBOS_AGENT_BUILTIN_SKILLS:-mbos-context}" \
