 ...
 * Notebook Fixtures
 *
 * Mock agent thread, turn, file, and task data for development and testing.
 */
...
export const sourceFileFixtures: FileItem[] = [
  {
    id: 'src_001',
    project_id: 'proj_001',
...
export const taskMessageFixtures: TaskMessage[] = [
  {
    id: 'msg_task_001_001',
    task_id: 'task_001',
    role: 'user',
