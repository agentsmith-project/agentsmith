...
export const CURRENT_GATE_MANIFEST: readonly CurrentGateDefinition[] = [
  ...
  defineCurrentGate({
    ...
    description: 'legacy focused diagnostic for unified deploy local substrate reset evidence',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
  ...
  defineCurrentGate({
    ...
    description: 'legacy focused diagnostic for local-kind deploy image handoff evidence',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
  ...
  defineCurrentGate({
    ...
    description: 'legacy focused diagnostic for local-kind rollout evidence',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
  ...
  defineCurrentGate({
    ...
    description: 'legacy focused diagnostic for deployed project, files, and managed runner task flows',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
