...
export PRESET_ENDPOINT_API_KEY="${PRESET_ENDPOINT_API_KEY:-${PRESET_ENDPOINT_API_KEY_VALUE:-}}"
...
run_playwright_command() {
  ...
  run_clean env \
    ...
    INTEGRATION_AGENT_TASK_RUNNER_BUILTIN_SKILLS="${INTEGRATION_AGENT_TASK_RUNNER_BUILTIN_SKILLS:-mbos-context}" \
