...
export default function AgentsPage({ params }: AgentsPageProps) {
  ...
  const canAgentRead = useHasPermission('project:agent:create');
  const canAgentCreate = useHasPermission('project:agent:create');
  const canAgentUpdate = useHasPermission('project:agent:create');
  const canAgentDelete = useHasPermission('project:agent:create');
  const canAgentKeyIssue = useHasPermission('project:agent:create');
  const canAgentKeyRevoke = useHasPermission('project:agent:create');
  const canAgentPublicPermission = useHasPermission('project:agent:publish');
