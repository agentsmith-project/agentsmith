...
if (!outputPath) {
  console.error('[write-workspace-governance-release-evidence] missing output path');
  process.exit(1);
}
...
const evidence = {
  ...
  note: 'Generated after workspace-governance-release-smoke completed successfully.',
};

writeFileSync(resolvedPath, JSON.stringify(evidence, null, 2), 'utf8');
console.log(`[write-workspace-governance-release-evidence] ${resolvedPath}`);
