...
export const CURRENT_GATE_MANIFEST: readonly CurrentGateDefinition[] = [
  ...
  defineCurrentGate({
    ...
    description: 'run the backend-real product readiness gate after default engineering preparation',
    kind: 'gate',
    visualPolicy: 'none',
    backendRealPolicy: 'required',
    storyEvidencePolicy: 'required',
  ...
  defineCurrentGate({
    ...
    description: 'transition-only focused diagnostic for unified deploy local substrate reset evidence',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
  ...
  defineCurrentGate({
    ...
    description: 'transition-only focused diagnostic for local-kind deploy image handoff evidence',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
  ...
  defineCurrentGate({
    ...
    description: 'transition-only focused diagnostic for local-kind rollout evidence',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
  ...
  defineCurrentGate({
    ...
    description: 'run the backend-real product readiness verification channel',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'required',
    storyEvidencePolicy: 'required',
  ...
  defineCurrentGate({
    ...
    description: 'evaluate aggregate AgentSmith product readiness evidence from campaign results',
    kind: 'gate',
    visualPolicy: 'full',
    backendRealPolicy: 'required',
    storyEvidencePolicy: 'required',
