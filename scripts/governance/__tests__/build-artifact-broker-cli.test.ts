...
const LLMUP_DIGEST = 'sha256:187394a51950148d696edd5e2d558d835d4238415060b2d5f6a23ea58e620976';
const LLMUP_SOURCE_IMAGE = `ghcr.io/agentsmith-project/llm-universal-proxy:v0.2.44@${LLMUP_DIGEST}`;
...
describe('build artifact broker CLI adapter', () => {
  it('does not require llmup source inputs and emits only the app target', () => {
    const fixture = stageBrokerFixture([
      ...
      'llm_universal_proxy_image=localhost:5001/mbos/llm-universal-proxy:v0.2.44',
