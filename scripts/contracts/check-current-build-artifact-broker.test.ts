...
describe('check-current-build-artifact-broker contract', () => {
  ...
  it('accepts provider image source locks with release URL and tag commit freshness fields', () => {
    const afscpLock = [
      'afscp_version=v1.0.20',
      'afscp_source_image=ghcr.io/agentsmith-project/agentsmith-fs-control-plane:v1.0.20@sha256:f0039fd21cc322c42784ae99069e288b0973f80002ba3a8c182e11a6110f340f',
      'afscp_release_url=https://github.com/agentsmith-project/agentsmith-fs-control-plane/releases/tag/v1.0.20',
      'afscp_commit_sha=c4f32b5c74783ccf5945a14c19d620dbf7824322',
      '',
    ].join('\n');
