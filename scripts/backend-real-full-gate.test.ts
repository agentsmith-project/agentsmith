...
describe('backend-real full gate runtime ownership contract', () => {
  ...
  it('exposes a gate-scoped AFSCP local runtime reset helper with the local-real marker', () => {
    ...
    expect(helper).toContain('export AFSCP_LOCAL_RUNTIME_IMAGE="${AFSCP_LOCAL_RUNTIME_IMAGE:-${AFSCP_IMAGE:-ghcr.io/agentsmith-project/agentsmith-fs-control-plane:v1.0.22@sha256:702c76775d828b9805056e51d841c0560eaaecb63a7f79a7e42d3f52de8029ca}}"');
