...
export const CURRENT_RELEASE_CAMPAIGN_EVIDENCE_TOPOLOGY = {
  ...
  unifiedDeploySubstrate: [
    {
      id: 'unified_deploy_substrate_native_result',
      path: '<campaign-root>/lane-unified-deploy-substrate/native/result.json',
      kind: 'file',
    },
    {
      id: 'unified_deploy_substrate_evidence',
      path: '<campaign-root>/unified-deploy/substrate',
      kind: 'recursive_file',
      fileName: '.json',
      minCount: 1,
    },
  ...
  unifiedDeployLocalKindImages: [
    {
      id: 'unified_deploy_local_kind_images_native_result',
      path: '<campaign-root>/lane-unified-deploy-local-kind-images/native/result.json',
      kind: 'file',
    },
    {
      id: 'unified_deploy_local_kind_images_evidence',
      path: '<campaign-root>/unified-deploy/local-kind-images',
      kind: 'recursive_file',
      fileName: '.json',
      minCount: 1,
    },
  ...
  unifiedDeployLocalKind: [
    {
      id: 'unified_deploy_local_kind_native_result',
      path: '<campaign-root>/lane-unified-deploy-local-kind/native/result.json',
      kind: 'file',
    },
    {
      id: 'unified_deploy_local_kind_evidence',
      path: '<campaign-root>/unified-deploy/local-kind',
      kind: 'recursive_file',
      fileName: '.json',
      minCount: 1,
    },
  ...
  unifiedDeployProductFlows: [
    {
      id: 'unified_deploy_product_flows_native_result',
...
export const CURRENT_RELEASE_FULL_CAMPAIGN_EVIDENCE_ARTIFACTS = [
  ...
  ...campaignEvidenceArtifactPaths('unifiedDeploySubstrate'),
  ...campaignEvidenceArtifactPaths('unifiedDeployLocalKindImages'),
  ...campaignEvidenceArtifactPaths('unifiedDeployLocalKind'),
  ...campaignEvidenceArtifactPaths('unifiedDeployProductFlows'),
...
export const CURRENT_GATE_MANIFEST: readonly CurrentGateDefinition[] = [
  ...
  defineCurrentGate({
    ...
    command: 'bash scripts/unified-deploy/release-substrate.sh',
    executionTargets: [shellScriptTarget('scripts/unified-deploy/release-substrate.sh')],
    description: 'reset and verify the unified deploy local substrate before Kubernetes rollout evidence',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
    campaignEvidenceArtifacts: campaignEvidenceArtifactPaths('unifiedDeploySubstrate'),
    checklistDocs: ['docs/user-guides/release-readiness-checklist.md'],
    requiredFor: ['release'],
  }),
  defineCurrentGate({
    ...
    command: 'bash scripts/unified-deploy/release-local-kind-images.sh',
    executionTargets: [shellScriptTarget('scripts/unified-deploy/release-local-kind-images.sh')],
    description: 'produce local-kind deploy image handoff evidence for the unified deploy model',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
    campaignEvidenceArtifacts: campaignEvidenceArtifactPaths('unifiedDeployLocalKindImages'),
    checklistDocs: ['docs/user-guides/release-readiness-checklist.md'],
    requiredFor: ['release'],
  }),
  defineCurrentGate({
    ...
    command: 'bash scripts/unified-deploy/release-local-kind.sh',
    executionTargets: [shellScriptTarget('scripts/unified-deploy/release-local-kind.sh')],
    description: 'roll out the app in local kind through the unified deploy topology',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
    campaignEvidenceArtifacts: campaignEvidenceArtifactPaths('unifiedDeployLocalKind'),
    checklistDocs: ['docs/user-guides/release-readiness-checklist.md'],
    requiredFor: ['release'],
  }),
  defineCurrentGate({
    ...
    description: 'prove focused deployed product behavior for project, files, and managed runner task flows',
    kind: 'lane',
    visualPolicy: 'none',
    backendRealPolicy: 'none',
    campaignEvidenceArtifacts: campaignEvidenceArtifactPaths('unifiedDeployProductFlows'),
    checklistDocs: ['docs/user-guides/release-readiness-checklist.md'],
    requiredFor: ['release'],
  }),
  defineCurrentGate({
