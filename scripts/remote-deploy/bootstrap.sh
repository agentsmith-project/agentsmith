...
DEMO_CREDENTIAL_NAME="${MBOS_DEMO_CREDENTIAL_NAME:-glm-shared-key}"
DEMO_ANTHROPIC_ENDPOINT_NAME="${MBOS_DEMO_ANTHROPIC_ENDPOINT_NAME:-glm5-anthropic-demo}"
DEMO_OPENAI_ENDPOINT_NAME="${MBOS_DEMO_OPENAI_ENDPOINT_NAME:-glm5-openai-demo}"
