...
const REQUIRED_OPERATIONS: Array<{ method: string; path: string }> = [
  ...
  { method: 'get', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/agent-runners' },
  { method: 'post', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/agent-runners' },
  { method: 'get', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/agent-runners/{agentRunnerId}/connection-info' },
  { method: 'get', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/agent-runners/{agentRunnerId}/keys' },
  { method: 'post', path: '/api/v1/workspaces/{workspaceId}/projects/{projectId}/agent-runners/{agentRunnerId}/keys' },
