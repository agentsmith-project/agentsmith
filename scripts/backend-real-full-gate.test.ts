...
describe('backend-real full gate runtime ownership contract', () => {
  ...
  it('exposes a gate-scoped AFSCP local runtime reset helper with the local-real marker', () => {
    ...
    expect(helper).toContain('export AFSCP_LOCAL_RUNTIME_IMAGE="${AFSCP_LOCAL_RUNTIME_IMAGE:-${AFSCP_IMAGE:-ghcr.io/agentsmith-project/agentsmith-fs-control-plane:v1.0.20@sha256:f0039fd21cc322c42784ae99069e288b0973f80002ba3a8c182e11a6110f340f}}"');
