...
const TEST_TRANSLATIONS: Record<string, string> = {
  ...
  'agent_tasks.conversation.input_placeholder': 'Type your message...',
  'agent_tasks.conversation.send': 'Send',
  'agent_tasks.conversation.hotkey_compose': 'Enter to send · Shift+Enter for newline',
  'agent_tasks.conversation.execution_settings_open': 'Open execution settings',
  'agent_tasks.conversation.execution_settings_close': 'Close execution settings',
  'agent_tasks.conversation.execution_settings_title': 'Execution settings',
  'agent_tasks.conversation.execution_settings_loading': 'Loading execution options...',
  'agent_tasks.conversation.execution_settings_error': 'Execution options could not be loaded. Retry before choosing a runner.',
  'agent_tasks.conversation.run_selection_project_default_badge': 'Project default',
  ...
  'stream_error_title_interrupted': 'Generation interrupted',
  'stream_error_title_agent_offline': 'External agent offline',
  'stream_error_title_agent_timeout': 'External agent timed out',
  'stream_error_title_agent_protocol': 'External agent protocol error',
  'stream_error_title_agent_upstream': 'External agent upstream failure',
  ...
  'notebook.conversation.realtime_error': 'Realtime connection: interrupted.',
