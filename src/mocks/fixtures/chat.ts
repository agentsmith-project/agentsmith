...
export const chatMessageFixtures: ChatMessageWithMeta[] = [
  ...
  },
  {
    ...
    session_id: 'chat_001',
    role: 'assistant',
    content: 'MBOS (Microservices-Based Operating System) is a platform for governed AI use. It provides project Chat, Agent tasks, Agent Runners, managed endpoints, and audit-backed multi-turn workflows.',
  ...
  },
  {
    ...
    session_id: 'chat_001',
    role: 'assistant',
    content: 'Key features include:\n\n1. **Agent tasks**: Run task workspaces with activity, terminal sessions, and artifacts\n2. **Endpoint Configuration**: Connect to various LLM providers (OpenAI, Anthropic, custom)\n3. **Agent Runners**: Configure managed task execution capability\n4. **File Libraries**: Manage project file libraries for task context\n5. **Access Control**: Token-based permissions and audit logging\n6. **Usage Tracking**: Monitor API usage and set limits',
