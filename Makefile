.PHONY: help bootstrap deps-up deps-ready deps-down deps-reset deps-smoke deps-logs deps-ps deps-init deps-init-postgres deps-init-keycloak \
	...
	governance-policy-access-effect-smoke governance-policy-group-access-effect-smoke governance-policy-update-audit-smoke governance-policy-quota-effect-smoke governance-agent-policy-rate-effect-smoke governance-agent-policy-quota-effect-smoke governance-member-quota-effect-smoke governance-member-permission-effect-smoke governance-member-lifecycle-effect-smoke \
...
help:
	...
	@echo "  make governance-agent-policy-quota-effect-smoke # real-backend agent policy quota effect smoke (notebook preflight -> audit/usage evidence)"
...
governance-agent-policy-quota-effect-smoke:
	env -u http_proxy -u https_proxy -u all_proxy -u HTTP_PROXY -u HTTPS_PROXY -u ALL_PROXY -u no_proxy -u NO_PROXY \
	./scripts/governance-agent-policy-quota-effect-smoke.sh
