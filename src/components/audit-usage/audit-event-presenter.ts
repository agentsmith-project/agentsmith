...
const ACTION_LABELS: Record<string, string> = {
  ...
  project_member_manage: 'Managed Member Access',
  'agent_runner.create': 'Created Agent Runner',
  agent_runner_create: 'Created Agent Runner',
  'agent_runner.update': 'Updated Agent Runner',
  agent_runner_update: 'Updated Agent Runner',
  'agent_runner.delete': 'Deleted Agent Runner',
  agent_runner_delete: 'Deleted Agent Runner',
  'agent_runner.key.issue': 'Issued Agent Runner Key',
  agent_runner_key_issue: 'Issued Agent Runner Key',
  'agent_runner.key.create': 'Created Agent Runner Key',
  agent_runner_key_create: 'Created Agent Runner Key',
  'agent_runner.key.revoke': 'Revoked Agent Runner Key',
  agent_runner_key_revoke: 'Revoked Agent Runner Key',
  ...
  'source.file.upload': 'Uploaded Source File',
  source_file_upload: 'Uploaded Source File',
  'source.file.delete': 'Deleted Source File',
  source_file_delete: 'Deleted Source File',
  'source.file.download': 'Downloaded Source File',
  source_file_download: 'Downloaded Source File',
