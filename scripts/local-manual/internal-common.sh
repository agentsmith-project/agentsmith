...
AFSCP_JVS_RELEASE_CACHE_DIR="${AFSCP_JVS_RELEASE_CACHE_DIR:-${INTERNAL_REAL_DIR}/jvs-release/${AFSCP_JVS_RELEASE_VERSION}}"
...
prepare_afscp_local_runtime_env() {
  ...
  AFSCP_RESTORE_PREVIEW_RECOVERY_ENABLED="${AFSCP_RESTORE_PREVIEW_RECOVERY_ENABLED:-true}"
  AFSCP_RESTORE_PREVIEW_DISCARD_RECOVERY_ENABLED="${AFSCP_RESTORE_PREVIEW_DISCARD_RECOVERY_ENABLED:-true}"
  AFSCP_RESTORE_RUN_RECOVERY_ENABLED="${AFSCP_RESTORE_RUN_RECOVERY_ENABLED:-true}"
