...
export const CURRENT_WORKFLOW_MANIFEST: readonly CurrentWorkflowSection[] = [
  {
    ...
    commands: [
      {
        command: 'make substrate-up SUBSTRATE=local-dev',
      ...
      {
        command: 'make substrate-reseed SUBSTRATE=local-dev',
      ...
      {
        command: 'make substrate-status SUBSTRATE=local-dev',
      ...
      {
        command: 'make substrate-down SUBSTRATE=local-dev',
        description: 'stop the managed substrate',
        canonical: 'make',
        makeTarget: 'substrate-down',
      },
      {
        command: 'make substrate-reset SUBSTRATE=local-dev',
      ...
      },
      {
        ...
        description: 'start the local demo deploy rehearsal line',
        canonical: 'make',
      ...
      },
      {
        ...
        description: 'bootstrap the local demo deploy rehearsal line',
        canonical: 'make',
        makeTarget: 'demo-rehearsal-bootstrap',
      },
      {
        command: 'make demo-rehearsal-verify',
        description: 'verify the local demo deploy rehearsal line',
        canonical: 'make',
        makeTarget: 'demo-rehearsal-verify',
      },
      {
        command: 'make demo-rehearsal-report',
        description: 'write the local demo deploy rehearsal report',
        canonical: 'make',
        makeTarget: 'demo-rehearsal-report',
      },
      {
        command: 'make cluster-rehearsal-up',
        description: 'start the local cluster deploy rehearsal line',
        canonical: 'make',
      ...
      },
      {
        ...
        description: 'bootstrap the local cluster deploy rehearsal line',
        canonical: 'make',
        makeTarget: 'cluster-rehearsal-bootstrap',
      },
      {
        command: 'make cluster-rehearsal-verify',
        description: 'verify the local cluster deploy rehearsal line',
        canonical: 'make',
        makeTarget: 'cluster-rehearsal-verify',
      },
      {
        command: 'make cluster-rehearsal-report',
        description: 'write the local cluster deploy rehearsal report',
        canonical: 'make',
