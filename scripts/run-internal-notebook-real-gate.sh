...
set +e
(
  cd "${ROOT_DIR}" &&     BACKEND_REAL_API_KEY="${BACKEND_REAL_API_KEY_VALUE}"     SANDBOX_MANAGER_URL="http://127.0.0.1:${SANDBOX_PORT}"     SANDBOX_SERVICE_KEY="${SANDBOX_SERVICE_KEY_VALUE}"     DATABASE_URL="postgresql://mbos:mbos_dev_password@localhost:${INTEGRATION_POSTGRES_PORT}/mbos"     MONGO_URL="${MONGO_URL}"     MONGO_DB_NAME="${MONGO_DB_NAME}"     REDIS_URL="redis://localhost:${INTEGRATION_REDIS_PORT}"     MINIO_ENDPOINT="localhost"     MINIO_PORT="${INTEGRATION_MINIO_API_PORT}"     KEYCLOAK_BASE_URL="${KEYCLOAK_BASE_URL}"     KEYCLOAK_URL="${KEYCLOAK_BASE_URL%/}/realms"     INTERNAL_AGENT_K8S_NAMESPACE="${K8S_NAMESPACE}"     INTERNAL_AGENT_JUICEFS_CSI_DRIVER="${CSI_DRIVER}"     INTERNAL_AGENT_WORKSPACE_CAPACITY="${WORKSPACE_CAPACITY}"     INTERNAL_AGENT_JUICEFS_STORAGE_CLASS_NAME="${STORAGE_CLASS_NAME}"     INTERNAL_AGENT_JUICEFS_MOUNT_OPTIONS="${MOUNT_OPTIONS}"     INTERNAL_AGENT_JUICEFS_SUBDIR="${SUBDIR}"     INTERNAL_AGENT_JUICEFS_MOUNT_SERVICE_ACCOUNT="${MOUNT_SERVICE_ACCOUNT}"     INTERNAL_AGENT_JUICEFS_MOUNT_IMAGE="${MOUNT_IMAGE_OVERRIDE}"     INTERNAL_AGENT_JUICEFS_META_HOST_OVERRIDE="${INTERNAL_AGENT_JUICEFS_META_HOST_OVERRIDE_VALUE}"     INTERNAL_AGENT_JUICEFS_META_PORT_OVERRIDE="${INTERNAL_AGENT_JUICEFS_META_PORT_OVERRIDE_VALUE}"     INTERNAL_AGENT_JUICEFS_STORAGE_ENDPOINT_OVERRIDE="${INTERNAL_AGENT_JUICEFS_STORAGE_ENDPOINT_OVERRIDE_VALUE}"     INTEGRATION_CLIENT_JUICEFS_META_HOST_OVERRIDE="${INTEGRATION_CLIENT_JUICEFS_META_HOST_OVERRIDE_VALUE}"     INTEGRATION_CLIENT_JUICEFS_META_PORT_OVERRIDE="${INTEGRATION_CLIENT_JUICEFS_META_PORT_OVERRIDE_VALUE}"     INTEGRATION_CLIENT_JUICEFS_STORAGE_ENDPOINT_OVERRIDE="${INTEGRATION_CLIENT_JUICEFS_STORAGE_ENDPOINT_OVERRIDE_VALUE}"     INTEGRATION_INTERNAL_AGENT_IMAGE="${RUNNER_IMAGE}"     AGENT_EXECUTION_WS_BASE_URL="${AGENT_EXECUTION_WS_BASE_URL_VALUE}"     INTERNAL_REAL_VISUAL_ARTIFACT_DIR="${INTERNAL_VISUAL_ARTIFACT_DIR}"     INTERNAL_SANDBOX_REAL_STATE_FILE="${STATE_FILE}"     INTEGRATION_KEEP_FAILED_ENV="${KEEP_FAILED_ENV}"     POSTGRES_PORT="${INTEGRATION_POSTGRES_PORT}"     MONGO_PORT="${INTEGRATION_MONGO_PORT}"     REDIS_PORT="${INTEGRATION_REDIS_PORT}"     MINIO_API_PORT="${INTEGRATION_MINIO_API_PORT}"     MINIO_CONSOLE_PORT="${INTEGRATION_MINIO_CONSOLE_PORT}"     KEYCLOAK_PORT="${INTEGRATION_KEYCLOAK_PORT}"     INTEGRATION_API_PORT="${API_PORT}"     INTEGRATION_WEB_PORT="${WEB_PORT}"     bash scripts/run-integration-e2e-full.sh       e2e/integration-internal-notebook-workspace.spec.ts       e2e/integration-internal-sandbox-reclaim.spec.ts
)
GATE_STATUS=$?
set -e
