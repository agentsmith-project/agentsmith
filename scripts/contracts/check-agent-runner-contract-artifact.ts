...
function createConsumerFiles(consumerDir: string): void {
  ...
  writeFileSync(
    ...
    [
      ...
      "if (PROJECTED_DEPENDENCIES_ENV_FIXTURE.dependencies['feishu-managed-user'].fields.access_token !== 'projected_access_token') throw new Error('projected dependencies env fixture missing');",
      "if (PROJECTED_DEPENDENCIES_ENV_FIXTURE.dependencies['jira-auth'].fields.base_url !== 'https://jira.example.com') throw new Error('projected dependencies env jira base_url fixture missing');",
      "if (PROJECTED_DEPENDENCIES_ENV_FIXTURE.dependencies['jira-auth'].fields.token !== 'projected_jira_token') throw new Error('projected dependencies env jira token fixture missing');",
  ...
  writeFileSync(
    ...
    [
      ...
      "const projectedDependencyAccessToken: string = PROJECTED_DEPENDENCIES_ENV_FIXTURE.dependencies['feishu-managed-user'].fields.access_token;",
      "const projectedDependencyJiraBaseUrl: string = PROJECTED_DEPENDENCIES_ENV_FIXTURE.dependencies['jira-auth'].fields.base_url;",
      "const projectedDependencyJiraToken: string = PROJECTED_DEPENDENCIES_ENV_FIXTURE.dependencies['jira-auth'].fields.token;",
      ...
      'void projectedDependencyJiraBaseUrl;',
      'void projectedDependencyJiraToken;',
      'void spec;',
      'void terminalType;',
      '',
    ].join('\n'),
