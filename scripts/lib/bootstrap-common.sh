...
run_deploy_bootstrap() {
  ...
  PRESET_ENDPOINT_MODEL="${PRESET_ENDPOINT_MODEL:-deepseek-v4-flash}"
  ...
  PRESET_ANTHROPIC_ENDPOINT_NAME="${PRESET_ANTHROPIC_ENDPOINT_NAME:-deepseek-primary}"
  PRESET_ANTHROPIC_ENDPOINT_BASE_URL="${PRESET_ANTHROPIC_ENDPOINT_BASE_URL:-https://api.deepseek.com/anthropic}"
  PRESET_ANTHROPIC_ENDPOINT_PROTOCOL="${PRESET_ANTHROPIC_ENDPOINT_PROTOCOL:-anthropic_messages}"
  PRESET_OPENAI_ENDPOINT_NAME="${PRESET_OPENAI_ENDPOINT_NAME:-deepseek-openai}"
  PRESET_OPENAI_ENDPOINT_BASE_URL="${PRESET_OPENAI_ENDPOINT_BASE_URL:-https://api.deepseek.com}"
