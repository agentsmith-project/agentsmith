...
2. `llm-provider-proxy-billing-prd-v1.md`
- 产品目标、范围、验收主要求（基线 PRD）

3. `llm-provider-proxy-billing-prd-v2-execution-blueprint.md`
- 工程执行蓝图（架构冻结、数据模型、里程碑、退出标准）

4. `llm-runtime-detailed-work-plan-v1.md`
- 页面/API/测试/阶段性交付的详细工作计划

5. `llm-provider-proxy-billing-e2e-test-plan-v1.md`
- E2E 覆盖矩阵与关键业务链路测试计划

6. `llm-provider-proxy-billing-contract-integration-checklist-v1.md`
- 契约/集成检查清单（发布门禁）
