...
online adoption 与 AgentSmith product-flow evidence 分别收口；release-kit operator
...
P5 runner publish manifest focused evidence 已完成：runner final HEAD `8b2541d`，
final publish run `26582224675` success，artifact id `7269115958`，published
image ref `ghcr.io/agentsmith-project/agentsmith-runner:release-p5-publish-8b2541d@sha256:26ba63e1e8c92ac9f8499c55bf4aeaf15c463f0e0682eee523268ee84b44fde7`。
AgentSmith manifest/lock adoption 已完成：positive manifest fixture 与 canonical
`agentsmith-runner-image.lock` 已采用 final publish manifest/run `26582224675`
...
11. `deploy_template_package.required_image_ids` 已提供机器可读 required image
    ...
    adoption 仍不能宣称完成，因为
    release-kit P2 full online adoption、AgentSmith product-flow evidence 收口、P3
...
6. P4/P5.0 已证明 runner contract artifact 的 descriptor/package URI、digest
   ...
   checklist 已修复。
   P5 runner publish manifest focused evidence 已完成：final runner HEAD `8b2541d`，
   final publish run `26582224675` success，manifest artifact id `7269115958`，
   image ref
   `ghcr.io/agentsmith-project/agentsmith-runner:release-p5-publish-8b2541d@sha256:26ba63e1e8c92ac9f8499c55bf4aeaf15c463f0e0682eee523268ee84b44fde7`。
   P5 request-scoped projected dependencies contract/env wiring focused slice 已完成：
...
P2 full online adoption 与 AgentSmith product-flow evidence 分别收口 ->
P3 airgap mechanism 剩余 offline install/deploy smoke 收口 -> P6-lite 清理当前并行收口 ->
...
`b80ea3c feat: add runner image smoke gate`，remote CI run `26468415599`
success；P5 runner publish manifest focused evidence 已完成，runner HEAD `8b2541d`，
final publish run `26582224675` success，manifest artifact id `7269115958`；P5
...
release-kit P2 full online adoption、AgentSmith product-flow evidence 收口、P3 airgap
mechanism 的 offline install/deploy smoke 和 P5 runtime 后续 wiring
等后续阶段未完成；release-kit operator signature/identity/full verdict
（正式签名验证/身份/完整 verdict）deferred，只有出现明确客户/合规/发布消费方需要时再做，
真实 deploy/smoke 站稳前不推进；AgentSmith manifest/lock adoption、release contract runner digest
...
P5.2 historical workflow_dispatch 的 producer/handoff/consumer jobs 全部
...
`8b2541d9e2b11b3b97481443b061cb7fbc952080`（short `8b2541d`），final publish run
`26582224675` success，使用 AgentSmith contract artifact package
`gh-artifact://agentsmith-project/agentsmith/runner-contract-artifact/26580019002/mbos-agent-runner-contract-0.1.0.tgz`；
uploaded `runner-release-manifest` artifact id `7269115958`，published image ref
`ghcr.io/agentsmith-project/agentsmith-runner:release-p5-publish-8b2541d@sha256:26ba63e1e8c92ac9f8499c55bf4aeaf15c463f0e0682eee523268ee84b44fde7`；
...
不是治理脚本失败。下一步是 P2 full online adoption 与 AgentSmith product-flow
evidence 分别收口；release-kit operator signature/identity/full verdict
（正式签名验证/身份/完整 verdict）deferred，只有出现明确客户/合规/发布消费方需要时再做，
真实 deploy/smoke 站稳前不推进；P3 airgap image load/import focused diagnostic 已完成，
