...
export const CURRENT_VERIFICATION_CAMPAIGN_MANIFEST: readonly CurrentVerificationCampaignDefinition[] = [
  {
    ...
    steps: [
      ...
      campaignStep({
        ...
        evidenceHints: findCurrentGateDefinitionById('lane-unified-deploy-substrate')?.campaignEvidenceArtifacts ?? [],
        evidenceChecks: campaignEvidenceChecks('unifiedDeploySubstrate'),
        nativeResult: {
          gateId: 'lane-unified-deploy-substrate',
      ...
      campaignStep({
        ...
        defaultFailureClass: 'infra_setup_failure',
        dependsOn: ['lane-unified-deploy-substrate'],
        evidenceHints: findCurrentGateDefinitionById('lane-unified-deploy-local-kind-images')?.campaignEvidenceArtifacts ?? [],
        evidenceChecks: campaignEvidenceChecks('unifiedDeployLocalKindImages'),
        nativeResult: {
          gateId: 'lane-unified-deploy-local-kind-images',
      ...
      campaignStep({
        ...
        evidenceHints: findCurrentGateDefinitionById('lane-unified-deploy-local-kind')?.campaignEvidenceArtifacts ?? [],
        evidenceChecks: campaignEvidenceChecks('unifiedDeployLocalKind'),
        nativeResult: {
          gateId: 'lane-unified-deploy-local-kind',
      ...
      campaignStep({
        ...
        defaultFailureClass: 'product_regression',
        dependsOn: ['lane-unified-deploy-local-kind'],
        evidenceHints: findCurrentGateDefinitionById('lane-unified-deploy-product-flows')?.campaignEvidenceArtifacts ?? [],
        evidenceChecks: campaignEvidenceChecks('unifiedDeployProductFlows'),
        nativeResult: {
          gateId: 'lane-unified-deploy-product-flows',
