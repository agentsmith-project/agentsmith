...
Use the local helper script to talk to the AgentSmith Context Store over the notebook execution API. This is the primary way to read or write member/task context, read project_member context, inspect simple credentials, and read shared project/workspace guidance.
