...
export function ConversationInput({
  ...
  return (
    <div className="border-t border-subtle bg-background/70 px-4 py-3" data-testid="notebook__conversation-input">
      <div
        className="rounded-xl border border-subtle bg-background/95 px-3 py-3 shadow-ambient"
        data-testid="notebook__conversation-input-shell"
      >
        <div className="flex items-end gap-3">
          <div
            ...
            data-testid="notebook__conversation-input-surface"
          >
            <textarea
              ref={textareaRef}
              value={value}
        ...
        {pendingQueue.length > 0 ? (
          <div className="mt-3 rounded-lg border border-subtle bg-surface-low/55 p-2.5" data-testid="notebook__pending-queue">
