...
不是治理脚本失败。kit_installed/online focused composition 已完成；下一步仍是
P2 full online adoption 与 AgentSmith product-flow evidence 分别收口；release-kit operator signature/identity/full verdict
（正式签名验证/身份/完整 verdict）deferred，只有出现明确客户/合规/发布消费方需要时再做，
