...
import type { QuotaOverride, QuotaTemplate } from '@/lib/api/types';
...
export interface EditQuotaTemplateDrawerProps {
  open: boolean;
      ...
      >
        ...
        <div className="flex-1 min-h-0 overflow-y-auto px-6 py-4 space-y-4">
          <div className="space-y-2">
            <Label htmlFor="edit-quota-template-name">{t('template_name')}</Label>
            <Input
              id="edit-quota-template-name"
              value={name}
              onChange={(e) => {
          ...
          <div className="space-y-2">
            <Label htmlFor="edit-quota-template-description">{t('template_description')}</Label>
            <Input
              id="edit-quota-template-description"
              value={description}
