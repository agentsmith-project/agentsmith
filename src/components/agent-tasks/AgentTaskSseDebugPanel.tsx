...
export interface AgentTaskSseDebugPanelProps {
  events: TaskSSEDebugEvent[];
}

export function AgentTaskSseDebugPanel({ events }: AgentTaskSseDebugPanelProps) {
  ...
  return (
    <div
      ...
      data-testid="agent-tasks__sse-debug-panel"
    >
