...
2026-06-11 当前 runtime readiness 证据已更新到 AgentSmith `d65624c055544f1be7ff4368cba1e0456b59195e`，旧 2026-06-09 `9a24a32` / Product Readiness Artifact `27182919783` / Release Contract Artifact `27182619840` / AFSCP `v1.0.20` 只保留为已被取代的历史上下文。当前 release contract artifact run 为 `27324797113`，path `/tmp/agentsmith-release-contract-27324797113/agentsmith-release-contract.json`，sha256 `616ecc1a3942ee3034c26deabbbc71db5711d119396d57d2f5322bec4c53303a`，release_id `main-d65624c05554`，git_sha `d65624c055544f1be7ff4368cba1e0456b59195e`。Product readiness run `27326370245` 已 `pass`，report path `/tmp/agentsmith-product-readiness-27326370245/artifacts/release-runs/product-readiness-27326370245/product-readiness/product-readiness-report.json`，report sha256 `92eefeec390720a6ee3bab1ab6cbd21b44555d7322d1577aa049f284ae377080`。Files restore continuation runtime details path `/tmp/agentsmith-product-readiness-27326370245/artifacts/release-runs/product-readiness-27326370245/gate-release/child-internal-evidence/files_restore_continuation_spec/runtime-readiness-details.json`，sha256 `cfd3b7c54221c3236f6bd39cbdb17f8aae6cd5a61956e0eb51fba9305bb9321b`，classification `clean_pass`，backoff intervals `[60000,90000,120000,180000,300000]`。当前 release contract 采用 AFSCP `v1.0.22`，digest `sha256:702c76775d828b9805056e51d841c0560eaaecb63a7f79a7e42d3f52de8029ca`，commit `ad4648f3ce6222cfd29266cb9a2e873d91bb7b64`。

2026-06-11 release-kit / operator handoff 证据同步到 `d65624c0` 口径。Airgap preclosure artifact 位于 `/home/percy/works/mbos-v1/.artifacts/agentsmith-release-kit-airgap-image-archives-27324797113-d65624c0-20260611`，`readiness=false`，summary sha256 `fcb097be050671048a9346e74a359fb3f59491def7d0baebdb7d17e556202d5f`，receipt sha256 `4bdbe8f00ff92d6a53262023752aff752e647e312824ae4e4021fba43917e2e4`。Operator-inputs scaffold handoff 位于 `/home/percy/works/mbos-v1/.artifacts/agentsmith-ga-operator-inputs-handoff-prep-d65624c0-20260611/handoff-summary.txt`，doctor exit codes 在真实 operator facts 提供前仍为 `1`；GA handoff index 位于 `/home/percy/works/mbos-v1/.artifacts/agentsmith-ga-handoff-index-d65624c0-20260611/handoff-index.md`。当前最终 GA blocker 仍是外部 operator-site artifacts：four real package-run outputs 加 online / airgap post-deploy product smoke；本段只刷新当前 evidence clarity，不表示 GA 已完成，也不新增 gate/report/governance 概念。
